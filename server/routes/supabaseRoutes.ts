...
import { addOrganizations, getOrgIdFromDB } from "../controllers/supabase/organizationController";
...
import { addEvaluations, getEvaluations, addSelfEvaluation } from "../controllers/supabase/evaluationController";
...
// -- Assignment routes --
// GET assignment(s)
router.get("/:org/assignments", attachGithubId, validateOrgAccess, getAssignments);
// POST assignment(s)
router.post("/:org/assignments", attachGithubId, validateOrgAccess, addAssignments);
...
// -- Evaluation routes --
// GET evaluation(s)
router.get("/:org/evaluations", attachGithubId, validateOrgAccess, getEvaluations);
// POST evaluation(s)
router.post("/:org/evaluations", attachGithubId, validateOrgAccess, addEvaluations);
